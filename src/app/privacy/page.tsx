  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-12">
      <div className="prose prose-lg prose-blue max-w-none">
        ...
        <p>
          At <strong>Know Your Views</strong>, accessible from{" "}
          <Link href="/" className="text-blue-600 hover:underline">
            https://knowyourviews.com
          </Link>
          , one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by Know Your Views and how we use it.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          ...
          <li>
            <strong>Log Data:</strong> Like many other websites, Know Your Views
        ...
        <p>
          ...
          advertising partners of Know Your Views.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Know Your Views, which are
        ...
        <p className="italic text-sm text-gray-500">
          Note that Know Your Views has no access to or control over these
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>By email: privacy@knowyourviews.com</li>
          <li>
