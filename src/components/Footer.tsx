...
const navigation = {
  ...
  company: [
    { name: "About Us", href: "/about" }, // Critical for AdSense
    { name: "Careers", href: "/careers" },
    { name: "Contact Us", href: "/contact" }, // Critical for AdSense
    { name: "Editorial Policy", href: "/editorial-policy" },
  ],
  legal: [
    { name: "Privacy Policy", href: "/privacy" }, // Critical for AdSense
    { name: "Terms of Service", href: "/terms" }, // Critical for AdSense
        ...
        <div className="mx-auto flex max-w-[110rem] flex-col items-start gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <form className="w-full max-w-md">
            <div className="flex gap-x-3">
              ...
              <button
                type="submit"
                className="flex-none rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 flex items-center"
              >
                Subscribe <PaperAirplaneIcon className="ml-2 h-4 w-4" />
              </button>
            </div>
